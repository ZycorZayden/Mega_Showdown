...
public record BattleStatePacketS2C(List<String> fieldEffects,
                                   List<BattleSideState> sides) implements CustomPacketPayload {
    ...
    public boolean equals(Object other) {
        if (!(other instanceof BattleStatePacketS2C(List<String> otherEffects, List<BattleSideState> otherSides)))
            return false;
